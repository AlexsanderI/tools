module.exports = {
  extends: 'eslint-config-airbnb-base', //(важно не забыть установить плагины $ npm i -D eslint-plugin-import )такжк существуют стондартные настройки правил, например airbnb они написали свой свод правил которые многим разработчикам понравились и эти правила используются часто
  rules: {
    'no-console': 0,
    'linebreak-style': 0,
  },
