...
export const onToggleTask = e => {
  ...
  const isDelete = e.target.classList.contains('list__item_delete-btn'); // if (!isCheckbox) {
  //   return;
  // }
  ...
  if (isCheckbox) updateTask(taskId, updatedTask).then(() => getTasksList()).then(newTasksList => {
