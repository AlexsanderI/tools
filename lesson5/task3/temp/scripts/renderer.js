...
const creatCheckbox = ({
  ...
  checkboxElem.classList.add('list__item-checkbox'); // checkboxElem.classList.add('list__item-checkbox');
...
export const creatListItem = ({
  ...
  const checkboxElem = creatCheckbox({
    done,
    id
  });
